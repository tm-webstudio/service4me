...
export function AdminDashboard() {
  ...
  const handleSaveStylist = async () => {
    ...
    try {
      ...
      // Clear all uploaded images after successful profile creation
      setGalleryImages([])
      setProfilePhoto('')
  ...
  const handleServiceImageSelect = useCallback((event: React.ChangeEvent<HTMLInputElement>) => {
    const file = event.target.files?.[0]
    if (file) {
  ...
  const triggerServiceImageSelect = useCallback(() => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Tabs defaultValue="pending" className="space-y-6">
        ...
        <TabsContent value="create" className="space-y-6">
          ...
          {/* Profile Settings Grid - matches stylist dashboard layout */}
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400 mt-3">JPG, PNG or GIF. Max 5MB each. Up to 20 images total.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              {/* Services List */}
              <div>
                <h4 className="font-semibold text-gray-900 mb-3">Current Services</h4>
